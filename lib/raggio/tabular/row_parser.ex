defmodule Raggio.Tabular.RowParser do
  @moduledoc """
  Row parser for converting raw row streams into typed results.

  This module takes a stream of `{row_number, cells}` tuples (from any
  `Raggio.Tabular.Parser` implementation) and applies SheetSchema
  validation to produce typed results.
